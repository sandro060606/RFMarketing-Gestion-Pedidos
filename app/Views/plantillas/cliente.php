...
<head>
    ...
    <title>RF Marketing — <?= $titulo ?? 'Panel Cliente' ?></title>
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="profile-info">
            <p class="profile-name"><?= esc($nombre . ' ' . $apellidos) ?></p>
            <span class="profile-rol"><?= esc($rol) ?></span>
        </div>
    </div>
                ...
                <a href="<?= base_url('cliente/notificaciones') ?>"
                   class="nav-link-item <?= (uri_string() == 'cliente/notificaciones') ? 'active' : '' ?>">
                    ...
                    <?php if (isset($notif_no_leidas) && $notif_no_leidas > 0): ?>
                        <span class="nav-badge notif"><?= $notif_no_leidas ?></span>
                    <?php endif; ?>
                </a>
            </li>
        </ul>
        ...
        <div class="topbar-right">
            ...
            <div class="topbar-user">
                ...
                <div class="topbar-user-info">
                    <span class="topbar-user-name"><?= esc($nombre . ' ' . $apellidos) ?></span>
                    <?php if (isset($empresa)): ?>
                        <span class="topbar-user-empresa"><?= esc($empresa) ?></span>
                    <?php endif; ?>
                </div>
            </div>
